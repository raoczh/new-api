...
export function PlaygroundEmptyState({
  ...
  return (
    <div className='flex min-h-[min(520px,calc(100svh-18rem))] items-center justify-center px-1 py-8 md:py-12'>
      <div className='grid w-full max-w-2xl gap-6 text-start'>
        <div className='bg-muted/50 text-muted-foreground flex size-12 items-center justify-center rounded-xl border'>
        ...
        <div className='grid grid-cols-2 gap-2'>
          {starterPrompts.map(({ icon: Icon, text }) => {
            ...
            return (
              <Button
                className='h-auto min-h-16 justify-start gap-2 px-3 py-2.5 text-left whitespace-normal'
                key={text}
