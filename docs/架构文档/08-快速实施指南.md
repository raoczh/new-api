    ...
    <Card title={t("审计日志")}>
      <div style={{ marginBottom: 16, display: "flex", gap: 8 }}>
        ...
        >
          ...
          <Select.Option value="create_channel">创建渠道</Select.Option>
          <Select.Option value="delete_channel">删除渠道</Select.Option>
        </Select>
        ...
        >
          ...
          <Select.Option value="channel">渠道</Select.Option>
          <Select.Option value="token">令牌</Select.Option>
          <Select.Option value="option">配置</Select.Option>
        </Select>

        <Button onClick={loadLogs}>{t("刷新")}</Button>
      </div>
